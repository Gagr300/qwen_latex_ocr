...
![img](https://github.com/Gagr300/qwen_latex_ocr/blob/main/_images/_image/Pasted image 20260606001024.png)
...
|---------------------------------------------------------------------------------------------------------|------------------------------------------------------------| --------------------------------------------------------------- | ---------------------------------------------------------------------------- | ----------------------------------------------------------------- | ------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| ![img](https://github.com/Gagr300/qwen_latex_ocr/blob/main/_images/Pasted%20image%2020260603152842.png) | `\\sqrt { b ^ { 2 } - 4 a c }`                             | ` ```latex\n\\sqrt{b^2 - 4ac}\n``` `                            | ` ```latex\n\\sqrt{b^2 - 4ac}\n``` `                                         | ` \\sqrt { b ^ { 2 } - 4 a c } `                                  | ` \\sqrt { b ^ { 2 } - 4 a c } `                                    | ` \\sqrt{b^{2}-4ac} `                                                  |
| ![img](https://github.com/Gagr300/qwen_latex_ocr/blob/main/_images/Pasted%20image%2020260603152849.png) | `\\sqrt { x - y - z + x ^ { 2 } + y ^ { 2 } + z ^ { 2 } }` | ` ```latex\n\\sqrt{x - y - z + x^2 + y^2 + z^2}\n``` `          | ` ```latex\n\\sqrt{x - y - z + x^2 + y^2 + z^2}\n``` `                       | ` \\sqrt{x - y - z + x^2 + y^2 + z^2} `                           | ` \\sqrt { x - y - z + x ^ { 2 } + y ^ { 2 } + z ^ { 2 } } `        | ` \\sqrt { x - y - z + x ^ { 2 } + y ^ { 2 } + z ^ { 2 } } `           |
| ![img](https://github.com/Gagr300/qwen_latex_ocr/blob/main/_images/Pasted%image%20260603153247.png)     | `\\frac { 2 \\tan \\alpha } { 1 - \\tan ^ { 2 } \\alpha }` | ` ```latex\n\\frac{2 \\tan \\alpha}{1 - \\tan^2 \\alpha}\n``` ` | ` $$\\frac { 2 \\tan \\alpha } { 1 - \\tan ^ { 2 } \\alpha }$$ `             | ` \\frac { 2 \\tan \\alpha } { 1 - \\tan^2 \\alpha } `            | ` \\frac { 2 \\tan \\alpha } { 1 - \\tan ^ { 2 } \\alpha } `        | ` \\frac { 2 \\tan \\alpha } { 1 - \\tan ^ { 2 } \\alpha } `           |
| ![img](https://github.com/Gagr300/qwen_latex_ocr/blob/main/_images/photo1%1.jpg)                        | width=100)                                                 |                                                            | ` ```latex \sqrt{x - y + z - x^2 + y^2 + z^3} = 100 ``` `       | ` ```latex \sqrt{x - y + z - x^2 + y^2 + z^3} = 100 ``` `                    | ` \sqrt { x - y + z - x ^ { 2 } + y ^ { 2 } + z ^ { 3 } } = 100 ` | ` \sqrt { x - y + z - x ^ { 2 } + y ^ { 2 } + z ^ { 3 } } = 1 0 0 ` | ` \sqrt { x - y + z - x ^ { 2 } + y ^ { 2 } + z ^ { 3 } } = 1 0 0<br>` |
| ![img](https://github.com/Gagr300/qwen_latex_ocr/blob/main/_images/photo2.jpg)                          | width=100)                                                 |                                                            | ` ```latex x + y + z \approx 8 ``` `                            | ` ```latex x + y + z \approx 8 ``` `                                         | ` $$x + y + z \approx 8$$ `                                       | ` x + y + z \approx 8 `                                             | ` x + y + z \approx 8 `                                                |
| ![img](https://github.com/Gagr300/qwen_latex_ocr/blob/main/_images/_image/photo3.jpg)                   | width=100)                                                 |                                                            | ` ```latex D_{KL}(x\|\|y) ``` `                                 | ` ```latex \mathrm{P}_{\mathrm{K}} \left( x \, \mathrm{I} \, y \right) ``` ` | ` \mathrm{P}_{\mathrm{K}}\left(x \, \mathrm{I} \, y\right) `      | ` P _ { K \rightarrow } ( X 1 1 Y ) `                               | ` P _ { K \cup L } ( X \| Y ) `                                        |
...
![img](https://github.com/Gagr300/qwen_latex_ocr/blob/main/_images/Pasted%image%20260608010730.png)
## the first sft wrong images
![img](https://github.com/Gagr300/qwen_latex_ocr/blob/main/_images/Pasted%image%20260608013424.png)
**Loss curve for the second sft**
![img](https://github.com/Gagr300/qwen_latex_ocr/blob/main/_images/Pasted%image%20260608003344.png)
...
## without photo
![img](https://github.com/Gagr300/qwen_latex_ocr/blob/main/_images/Pasted%image%20260608010153.png)
## with a photo
![img](https://github.com/Gagr300/qwen_latex_ocr/blob/main/_images/Pasted%image%20260608010249.png)
## with answer

![img](https://github.com/Gagr300/qwen_latex_ocr/blob/main/_images/Pasted%image%20260608010415.png)

![img](https://github.com/Gagr300/qwen_latex_ocr/blob/main/_images/Pasted%image%20260608010609.png)